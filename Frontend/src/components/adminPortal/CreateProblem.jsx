  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="space-y-8">
          ...
          {[
            ...
            <div key={label}>
              ...
              <button type="button" onClick={() => append()} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]">
                <PlusCircle size={18} />
      ...
      <div className="flex justify-end items-center space-x-4 pt-4">
        ...
        <button type="submit" className="group flex items-center space-x-2 py-3 px-6 rounded-lg bg-gradient-to-r from-[#3B82F6] to-[#2563EB] hover:from-[#60A5FA] hover:to-blue-600 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5">

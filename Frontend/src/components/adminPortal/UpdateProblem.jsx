...
//   // --- UI & Styling ---
//   const inputBaseClasses = "w-full bg-[#F1F5F9] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] rounded-lg p-2.5 focus:ring-2 focus:ring-[#3B82F6] focus:border-[#3B82F6]/50 outline-none transition duration-200 placeholder:text-[#64748B]/60 dark:placeholder:text-[#94A3B8]/60";
...
//   const subCardClasses = "p-4 bg-[#F1F5F9] dark:bg-[#0F172A] rounded-xl border border-[#E2E8F0] dark:border-[#334155]/50 transition-all duration-300 hover:border-[#3B82F6]/30";
...
//         <h2 className={sectionTitleClasses}><List size={24} className="text-[#3B82F6]" /><span>Basic Information</span></h2>
...
//       {/* Section 2: Metadata */}
//       <div className={sectionClasses}>
//         <h2 className={sectionTitleClasses}><Tag size={24} className="text-[#3B82F6]" /><span>Metadata</span></h2>
...
//                 <div key={tag} className="flex items-center gap-1.5 bg-[#3B82F6]/20 text-[#3B82F6] text-sm font-medium px-2.5 py-1 rounded-full">
//                   {tag}
//                   <button type="button" onClick={() => removeTag(tag)} className="text-[#3B82F6] hover:bg-white/20 rounded-full p-0.5"><X size={14} /></button>
//                 </div>
...
//                 ))}
//               </div>
//               <button type="button" onClick={() => append()} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add {label.slice(0, -1)}</span></button>
...
//       <div className={sectionClasses}>
//           <h2 className={sectionTitleClasses}><FileJson size={24} className="text-[#3B82F6]" /><span>Examples & Test Cases</span></h2>
//           <div className="space-y-8">
//               <div>
...
//                           </div>
//                       ))}
//                       <button type="button" onClick={() => appendExample({ input: '', output: '', explanation: '' })} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add Example</span></button>
//                   </div>
//               </div>
//               <div>
//                   <h3 className="flex items-center space-x-2 text-md font-semibold mb-4 text-[#0F172A] dark:text-[#F8FAFC]">
...
//                       <button type="button" onClick={() => appendVisibleTC({ input: '', output: '' })} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add Visible Test Case</span></button>
//                   </div>
//               </div>
//               <div>
//                   <h3 className="flex items-center space-x-2 text-md font-semibold mb-4 text-[#0F172A] dark:text-[#F8FAFC]">
...
//                       <button type="button" onClick={() => appendHiddenTC({ input: '', output: '' })} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add Hidden Test Case</span></button>
//                   </div>
//               </div>
//           </div>
//       </div>
...
//       <div className={sectionClasses}>
//           <h2 className={sectionTitleClasses}><Code size={24} className="text-[#3B82F6]" /><span>Code Snippets</span></h2>
//           <div className="space-y-8">
//               <div>
//                   <h3 className="flex items-center space-x-2 text-md font-semibold mb-4 text-[#0F172A] dark:text-[#F8FAFC]">
...
//                       <button type="button" onClick={() => appendStarterCode({ language: 'javascript', headerCode: '', code: '', mainCode: '' })} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add Starter Code</span></button>
//                   </div>
//               </div>
//               <div>
//                   <h3 className="flex items-center space-x-2 text-md font-semibold mb-4 text-[#0F172A] dark:text-[#F8FAFC]">
...
//                       <button type="button" onClick={() => appendRefSolution({ language: 'javascript', solutionCode: '' })} className="mt-3 flex items-center space-x-2 text-sm text-[#3B82F6] font-semibold hover:text-[#60A5FA]"><PlusCircle size={18} /><span>Add Reference Solution</span></button>
//                   </div>
//               </div>
//           </div>
//       </div>
...
//           type="submit"
//           disabled={!isDirty}
//           className="group flex items-center space-x-2 py-3 px-6 rounded-lg bg-gradient-to-r from-[#3B82F6] to-[#2563EB] hover:from-[#60A5FA] hover:to-blue-600 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none disabled:transform-none"
//         >
...
const UpdateProblem = () => {
 ...
 const onSubmit = async (formData) => {
  // Safe array mapping with comprehensive fallbacks
  ...
  const payload = {
    ...formData,
    // Handle arrays that use the { value } structure
    constraints: safeMap(formData.constraints, c => c?.value?.trim()),
    companies: safeMap(formData.companies, c => c?.value?.trim()),
    hints: safeMap(formData.hints, h => h?.value?.trim()),
    
    // Handle example objects
    examples: safeMap(formData.examples, ex => ({
      input: ex?.input?.trim() || '',
      output: ex?.output?.trim() || '',
      explanation: ex?.explanation?.trim() || ''
    })),
    
    // Handle test case objects
    visibleTestCases: safeMap(formData.visibleTestCases, tc => ({
      input: tc?.input?.trim() || '',
      output: tc?.output?.trim() || ''
    })),
    hiddenTestCases: safeMap(formData.hiddenTestCases, tc => ({
      input: tc?.input?.trim() || '',
      output: tc?.output?.trim() || ''
    })),
    
    // Handle code objects
    starterCode: safeMap(formData.starterCode, sc => ({
      language: sc?.language?.trim() || '',
      headerCode: sc?.headerCode?.trim() || '',
      code: sc?.code?.trim() || '',
      mainCode: sc?.mainCode?.trim() || ''
    })),
    referenceSolution: safeMap(formData.referenceSolution, rs => ({

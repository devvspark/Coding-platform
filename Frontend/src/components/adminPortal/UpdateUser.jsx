...
const UpdateUser = () => {
  ...
  const inputBaseClasses = "w-full bg-[#F1F5F9] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] rounded-lg p-3 focus:ring-2 focus:ring-[#3B82F6] focus:border-[#3B82F6]/50 outline-none transition duration-200 placeholder:text-[#64748B]/60 dark:placeholder:text-[#94A3B8]/60";
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-[#FFFFFF] dark:bg-[#1E293B] p-8 rounded-xl border border-[#E2E8F0] dark:border-[#334155] shadow-md">
        <div className="text-center mb-8">
          <div className="inline-block p-4 bg-gradient-to-br from-[#3B82F6]/20 to-blue-500/20 rounded-full mb-4">
            <UserCog size={32} className="text-[#3B82F6]" />
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end items-center space-x-4 pt-4">
            ...
            <button
              type="submit"
              className="group flex items-center space-x-2 py-3 px-6 rounded-lg bg-gradient-to-r from-[#3B82F6] to-blue-500 hover:from-[#60A5FA] hover:to-blue-600 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5"
            >

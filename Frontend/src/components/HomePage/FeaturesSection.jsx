  ...
  <section id="features" className="py-16 sm:py-24 bg-white dark:bg-slate-900 transition-colors duration-300">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Learn. Practice. Master.</h2>
        <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-600 dark:text-gray-400">
        Access curated problems, compete in challenges, and track your progress as you level up your skills.
        </p>
      </div>

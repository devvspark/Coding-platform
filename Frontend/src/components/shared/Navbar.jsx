    ...
    <nav className="bg-white/80 dark:bg-gray-800/70 backdrop-blur-lg shadow-lg dark:shadow-xl fixed w-full z-50 top-0 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center" aria-label="CodeMaster Home">
            <CodeMasterLogo size={7} className="" /> 
            <span className="font-bold text-2xl text-slate-800 dark:text-white ml-3 tracking-tight">CodeMaster</span>
          </Link>
          ...
          <div className="md:hidden flex items-center">
            <button 
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-slate-500 dark:text-gray-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 dark:focus:ring-white transition-colors duration-150"
            ...
            <div className="flex flex-col space-y-3 px-3">
            {
              isAuthenticated ? (
                ...
                <>
                  ...
                  <button onClick={ ()=> { navigate("/signup") } } className="w-full text-left text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-md text-sm font-medium transition-colors duration-150 shadow-md hover:shadow-lg">
                    Sign Up
                  </button>
                </>
              )

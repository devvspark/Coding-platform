        ...
        >
          ...
          >
                  ...
                  >
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-5 w-5 rounded border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-slate-700 text-slate-800 dark:text-blue-500 focus:ring-slate-600 dark:focus:ring-blue-600 dark:focus:ring-offset-slate-800 cursor-pointer"
                      />
                ...
                {!isCreatingSprint ? (
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      className="block w-full px-3 py-2 bg-white dark:bg-slate-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-900 dark:text-white"
                      autoFocus
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <button
                        ...
                        className="px-4 py-1.5 rounded-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 transition-colors disabled:opacity-50"
            ...
            <div className="bg-gray-50 dark:bg-slate-900 px-6 py-4 rounded-b-lg flex justify-end mt-auto">
              <button
                onClick={handleSave}
                className="bg-blue-600 text-white font-semibold py-2 px-6 rounded-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-800 focus:ring-blue-500 transition-all duration-200"
              >
                Save
              </button>
            </div>

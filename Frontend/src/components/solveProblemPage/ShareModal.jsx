...
const ShareModal = ({ isOpen, onClose, problem }) => {
  ...
  const problemUrl = typeof window !== 'undefined'
    ...
    : `https://www.codemaster.dev/problems/${problem._id}`;

  const shareTextForSocial = `Check out the problem: "${problemTitle}" on CodeMaster!`;
  const shareMessageForCopy = `I'm working on the "${problemTitle}" problem on CodeMaster!\nCheck it out: <${problemUrl}>`;
          ...
          <FocusTrap active={isOpen}>
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={onClose}
                  className="p-1.5 rounded-full text-gray-500 hover:bg-gray-200 dark:text-slate-400 dark:hover:bg-slate-700 focus:ring-blue-500"
              ...
              <div className="mb-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`${commonButtonClass} px-4 text-sm font-medium bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-blue-500`}
                  >
              ...
              <div className="mb-8">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`${commonButtonClass} px-4 text-sm font-medium self-start bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-blue-500`}
                  >
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5 gap-4">
                  {socialPlatforms.map(platform => (
                    <a
                      ...
                      className={`${commonButtonClass} flex-col space-y-1 h-20 bg-gray-100 hover:bg-gray-200 text-gray-700 hover:text-blue-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-200 dark:hover:text-blue-400 focus:ring-blue-500`}

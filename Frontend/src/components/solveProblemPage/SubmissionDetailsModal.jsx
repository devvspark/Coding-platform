      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-200 dark:border-slate-700 flex-shrink-0">
          ...
          <button
            ...
            className="p-1.5 rounded-full text-gray-500 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-slate-700 hover:text-gray-700 dark:hover:text-slate-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
        ...
        >
          ...
          <textarea
            ...
            className={`w-full p-3 border rounded-md text-sm resize-none shadow-sm
                      bg-gray-50 border-gray-300 text-gray-800 placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500
                      dark:bg-slate-900/70 dark:border-slate-600 dark:text-slate-100 dark:placeholder-slate-400 dark:focus:ring-1 dark:focus:ring-blue-500 dark:focus:border-blue-500`}
            rows={4}
          ...
          <div className="mt-3 text-right">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md transition-colors
                          ...
                          dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700 dark:disabled:bg-blue-400 

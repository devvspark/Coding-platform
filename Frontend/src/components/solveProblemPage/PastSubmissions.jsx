                                      ...
                                      <div className="flex flex-col items-start sm:items-end w-full sm:w-auto">
                                          <p className="text-xs mb-2 text-gray-500 dark:text-slate-400">
                                            ...
                                            <button
                                              ...
                                              className="px-3 py-1.5 text-xs font-semibold rounded-md transition-colors bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-slate-800">
                                              View Details
                                            </button>
                                      </div>
                                   </div>

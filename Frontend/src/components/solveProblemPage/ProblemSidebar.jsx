        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-4 border-b border-gray-300 dark:border-slate-700">
            ...
            <button
              ref={closeButtonRef}
              onClick={onClose}
              className="p-1 rounded-md text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <li key={problem._id}>
                  ...
                  >
                    ...
                    <div className="flex-grow">
                        <span className={`text-sm font-medium group-hover:text-blue-500 ${ problem._id === currentProblemId ? "text-blue-500" : "text-gray-800 dark:text-slate-100" }`}>
                         {problem.title}
                        </span>
                    </div>

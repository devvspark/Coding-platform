   ...
   <div className="flex flex-col flex-grow bg-white dark:bg-slate-800">
          ...
          <div className="w-full max-w-md space-y-2.5">
            {predefinedQuestions.map((q, index) => (
              <button
                ...
                className="w-full text-left p-3 text-sm font-medium text-gray-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-700/60 rounded-lg border border-slate-200 dark:border-slate-600/80 hover:bg-slate-200/70 dark:hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {q}
              </button>
            ))}
            ...
            <div key={block.id} className='p-4 rounded-lg shadow-md bg-white border border-gray-200 dark:bg-slate-800 dark:border-slate-700'>
              <div>
                <div className="flex items-center mb-1.5">
                  <UserCircleIcon className="w-5 h-5 mr-2 flex-shrink-0 text-blue-500 dark:text-blue-400" />
      ...
      <div className="sticky bottom-0 mt-auto flex items-start border-t bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 p-4 px-1">
        ...
        <button
          ...
          className="ml-2 px-4 text-sm bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors 

  ...
  return (
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-15'>
        <button
          ...
          className="flex items-center space-x-2 text-sm font-semibold text-[#475569] dark:text-[#94a3b8] hover:text-[#3B82F6] dark:hover:text-[#3B82F6] transition-colors mb-6"
        >
          <ArrowLeft size={16} />
      ...
      <div className="flex justify-between items-start flex-wrap gap-4 mb-4">
        ...
        {/* <button className="bg-[#3B82F6] text-white font-medium px-6 py-2.5 rounded-lg text-sm hover:opacity-90 transition-opacity whitespace-nowrap">
          Start Sprint
        </button> */}
      </div>
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className="font-semibold py-1 px-3 rounded-md border transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-opacity-50
                                  text-blue-600 hover:text-blue-700 border-blue-500 hover:border-blue-600 hover:bg-blue-50 dark:text-blue-500 dark:hover:text-blue-400 dark:border-blue-500 dark:hover:border-blue-400 dark:hover:bg-blue-500/10

  ...
  return (
    <div className="max-w-4xl mx-auto pt-10 pb-40 px-4 sm:px-6 lg:px-8">
      ...
      <button
        ...
        className="flex items-center space-x-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors mb-10"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12">
            ...
            <div className="mt-10 md:mt-0 flex flex-col justify-center">
              <button
                ...
                disabled={isLoading}
                className="w-full bg-blue-500 text-white font-semibold py-4 rounded-lg flex items-center justify-center space-x-2 hover:opacity-90 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-lg shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
              >
                {isLoading ? (
                  <>

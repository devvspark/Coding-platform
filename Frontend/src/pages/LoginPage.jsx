...
import { CodeMasterLogo, InputField, SocialButton, GoogleIcon, LinkedInIcon, GithubIcon } from '../components';
...
// User clicks Social login button → handleSocialLogin('google').

// Browser redirects to backend /authentication/google.

// Backend redirects to Google consent page.

// User logs in → Google redirects back with code.

// Backend exchanges code → access token → fetches user info.

// Backend creates/updates user in database.

// Backend generates JWT token → sends as cookie.

// Backend redirects back to frontend → user is now logged in.

...
import { CodeMasterLogo } from "../components"
...
const FeatureCard = ({ icon, title, children }) => (
  <div className="bg-[#f8fafc] dark:bg-[#1a2332] p-7 rounded-lg border border-[#e2e8f0] dark:border-[#334155] transform hover:-translate-y-1 transition-transform duration-300">
    <div className="flex items-center justify-center w-12 h-12 bg-[#3B82F6]/10 dark:bg-[#3B82F6]/20 rounded-lg mb-4">
      {icon}
    </div>
...
const TechBadge = ({ href, children }) => {
  const badgeContent = (
    <span className="inline-block bg-slate-100 dark:bg-slate-700/50 text-slate-700 dark:text-slate-300 px-3 py-1 rounded-full text-sm font-medium border border-slate-200 dark:border-slate-600 transition-colors duration-200 group-hover:bg-[#3B82F6]/10 group-hover:border-[#3B82F6]/30 dark:group-hover:bg-[#3B82F6]/20 dark:group-hover:border-[#3B82F6]/40">
      {children}
    </span>
  );
...
const AboutUsPage = () => {
  const features = [
    {
      icon: <FileCode size={24} className="text-[#3B82F6]" />,
  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      <header className="text-center mb-16 relative">
        <CodeMasterLogo className="absolute inset-0 w-full h-full text-slate-200/30 dark:text-slate-800/40 -z-10 transform scale-150" />
        ...
        <div className="flex justify-center items-center">
          <div className="bg-[#ffffff] dark:bg-[#232b3b] p-8 rounded-xl border border-[#e2e8f0] dark:border-[#334155]">
            <h2 className="text-3xl font-bold mb-4 flex items-center">
              <Target size={30} className="mr-3 text-[#3B82F6]" />
              Our Mission
            </h2>
            <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed">
              ...
              of solution spoilers. CodeMaster was built to solve these challenges by providing a one-stop platform
      ...
      <section className="bg-[#ffffff] dark:bg-[#232b3b] rounded-xl p-8 md:p-12 border border-[#e2e8f0] dark:border-[#334155] mb-10">
        ...
        <div className="max-w-md mx-auto bg-[#f8fafc] dark:bg-[#1a2332] rounded-lg p-6 text-center shadow-lg">
          <img
            ...
            alt="Onkar Godase"
            className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-[#3B82F6]"
          />
          <h3 className="text-2xl font-bold text-[#1e293b] dark:text-[#e2e8f0]">Onkar Godase</h3>
          <p className="text-[#3B82F6] font-semibold mb-3">Full Stack Developer</p>
          <p className="text-[#475569] dark:text-[#94a3b8] mb-4">
            The mind and muscle behind CodeMaster, Prem is a passionate developer dedicated to creating tools that
            empower other coders. He built CodeMaster to solve the common hurdles faced by learners in the tech space.
          </p>
          <div className="flex justify-center space-x-4">
            <a href="https://github.com/devvspark" target="_blank" aria-label="Github Profile" className="text-slate-500 hover:text-[#3B82F6]">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/onkargodase" target="_blank" aria-label="LinkedIn Profile" className="text-slate-500 hover:text-[#3B82F6]">
              <Linkedin size={24} />
            </a>
          </div>
        </div>

...
import { updateUserProfile, updateUserProfileImage, logoutUser } from '../slices/authSlice';
...
const AccountPage = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      const response = await axiosClient.delete('/authentication/delete-account');
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            {newProfileImageFile ? (
              ...
              <button
                ...
                className="flex items-center px-4 py-2 text-sm font-medium rounded-md border transition-colors
                          text-blue-600 hover:text-blue-700 border-blue-500 hover:border-blue-600 bg-white hover:bg-blue-50
                          dark:text-blue-500 dark:hover:text-blue-400 dark:border-blue-500 dark:hover:border-blue-400 dark:bg-slate-700 dark:hover:bg-slate-600"
              >
                <IconCamera className="w-4 h-4 mr-2" />
                Change Photo
              </button>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center py-3 border-b border-slate-200 dark:border-slate-700">
            <div className="flex items-center w-full sm:w-1/3 mb-2 sm:mb-0">
              <IconUserCircle className="w-5 h-5 mr-3 text-blue-500" />
            ...
            <div className="flex-grow text-slate-900 dark:text-white">
              {isEditingProfile ? (
                <input
                  ...
                  {...register('fullName')}
                  className="w-full px-3 py-2 rounded-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 "
                />
              ) : (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center py-3 border-b border-slate-200 dark:border-slate-700 ">
            <div className="flex items-center w-full sm:w-1/3 mb-2 sm:mb-0">
              <IconIdentification className="w-5 h-5 mr-3 text-blue-500" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center py-3 border-b border-slate-200 dark:border-slate-700">
            <div className="flex items-center w-full sm:w-1/3 mb-2 sm:mb-0">
              <IconEnvelope className="w-5 h-5 mr-3 text-blue-500" />
          ...
          {isEditingProfile ? (
            <div className="flex justify-end space-x-3 pt-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {loadingSaveProfile ? (
                  <>
                    <svg
            ...
            <div className="flex justify-end pt-4">
              <button
                ...
                className="text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400 text-sm font-medium flex items-center"
              >

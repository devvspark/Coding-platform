                ...
                <article className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-[#3B82F6]">
                                Ads Settings
                            </a>. Alternatively, you can opt out of a third-party vendor's use of cookies for personalized advertising by visiting{' '}
                            <a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-[#3B82F6]">
                    ...
                    <p>
                        ...
                        <a href="mailto:contact@codemaster.dev" className="text-[#3B82F6]">
                            contact@codemaster.dev
                        </a>.
                    </p>
                </article>
            </div>

  ...
  if (!course) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-900">
        ...
        <Link to={APP_ROUTES.courses} className="ml-4 text-blue-600 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-400">Back to Courses</Link>
      </div>
    );
  }
      ...
      <div className="bg-slate-100 dark:bg-slate-800 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto lg:grid lg:grid-cols-3 lg:gap-x-12">
          <div className="lg:col-span-2">
            <p className="text-base font-semibold text-blue-600 dark:text-blue-500 uppercase tracking-wide">{course.category.join(', ')}</p>
                ...
                {course.curriculum.map((module) => (
                  <div key={ module.id} className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden border border-slate-200 dark:border-slate-700">
                    <button
                      ...
                      className="w-full flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-700 hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset"
                        ...
                        {module.lectures?.map((lecture) => (
                          <li key={lecture.contentDetails?.videoId}>
                            <Link to={APP_ROUTES.courseContent.replace(':courseId', course.id).replace(':lectureId', lecture.contentDetails?.videoId)} className="flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-700/50 group transition-colors">
                              <div className="flex items-center">
                                <VideoCameraIcon className="w-5 h-5 text-blue-500 dark:text-blue-500 mr-3 flex-shrink-0 group-hover:text-blue-600 dark:group-hover:text-blue-400" />
             ...
             <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-lg shadow-md sticky top-24 border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex items-center mb-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-blue-600 dark:text-blue-400">Lead Instructor</p>
                    </div>
                </div>

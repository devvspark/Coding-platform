      ...
      <div className="relative">
        ...
        <input
          ...
          className={`block w-full rounded-md border-0 bg-[#f8fafc] dark:bg-[#1a2332] py-3 pl-10 pr-3 text-[#1e293b] dark:text-[#e2e8f0] ring-1 ring-inset ${
            ...
            error ? 'focus:ring-red-500' : 'focus:ring-[#3B82F6]'
          }`}
          {...registerField}
        />
      </div>
    ...
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <header className="text-center mb-12">
        ...
        <p className="mt-2 text-[#475569] dark:text-[#94a3b8]">
          Email:{' '}
          <a href="mailto:contact@codemaster.dev" className="font-semibold text-[#3B82F6] hover:underline">
            onkarlgodase225@gmail.com
          </a>
        </p>
      </header>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className={`block w-full rounded-md border-0 bg-[#f8fafc] dark:bg-[#1a2332] py-3 px-4 text-[#1e293b] dark:text-[#e2e8f0] ring-1 ring-inset ${
                  ...
                  errors.message ? 'focus:ring-red-500' : 'focus:ring-[#3B82F6]'
                }`}
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center space-x-2 py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#3B82F6] hover:opacity-90 disabled:opacity-50 disabled:cursor-wait focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3B82F6]"
              >
                {isSubmitting ? (
                  <>

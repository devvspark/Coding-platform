      ...
      case 'ended':
        return (
          <button
            ...
            className="w-full sm:w-auto bg-[#3B82F6] text-white font-bold py-3 px-8 rounded-lg text-lg hover:opacity-90 transition-opacity flex items-center justify-center space-x-2"
          >
            <Trophy size={20} />
